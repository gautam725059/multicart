            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {roles.map((roleItem, index) => (
                <button
                  ...
                  rounded-xl bg-white/10 hover:bg-blue-500/20 border transition-all duration-300 ${role === roleItem.value ? "border-blue-500 bg-blue-500/20" : "border-white/20"
                    }`}
                >
                  <span className="text-2xl text-blue-400">{roleItem.icon}</span>
                  <span className="text-sm font-semibold">{roleItem.label}</span>
                </button>
              ))}
            </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 relative">
              ...
              <p className=" text-center text-sm text-gray-400 mt-4">
                ...
                <button type="button" onClick={() => router.push("/login")} className="text-blue-400 hover:underline">Login Here</button>
              </p>
            </form>
